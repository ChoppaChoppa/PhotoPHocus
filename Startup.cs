...
using PHotoFockus.Controllers;

namespace PHotoFockus
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IProductsCategory, CategoriesRepository>();
            services.AddTransient<IAllOrder, OrdersRepository>();
            services.AddTransient<IAddProduct, AddProductRepository>();
            services.AddTransient<IAboutUs, AboutUsRepository>();

            services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>();
            services.AddScoped(sp => FockusCart.GetCart(sp));
